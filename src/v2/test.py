...
MODEL_PATH='models/model_v2_finetuned.h5'
...
# ====== Accuracy and Loss ======
train_log = pd.read_csv('outputs/logs/train-logs_v2_finetuned.csv')
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'accuracy_and_loss_v2_finetuned.png'))
plt.close()
# ======= Confusion Matrix ========
...
plt.savefig(os.path.join(OUTPUT_DIR, 'confusion_matrix_v2_finetuned.png'))
plt.close()
...
with open(os.path.join(OUTPUT_DIR, 'classification_report_v2_finetuned.json'), 'w') as f:
